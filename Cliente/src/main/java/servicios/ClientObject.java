...
public class ClientObject {
    ...
    public static void main(String[] args) {
        ...
        MenuClient objMenu = new MenuClient("          === Menu ===          ", new String[]{"Ingresar y enviar datos de la canción", "Listar datos de las canciones registradas"}, objRemoteSong,objRemoteUser);
    }
}
